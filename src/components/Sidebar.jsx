...
export default function Sidebar({ courses, progressMap = {} }) {
  ...
  return (
    <aside
      // FIX IS HERE: changed 'h-full' to 'flex-1 min-h-0'
      // This ensures it fills the gap but respects the buttons below it
      className="glass-panel p-4 rounded-xl flex flex-col flex-1 min-h-0 overflow-hidden"
      aria-label="Course Selection"
    >
